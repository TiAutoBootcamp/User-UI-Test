using CoreAdditional.Libraries;
...
namespace UITests.StepDefinitions
{
    ...
    {
        //private readonly UserClient _userServiceClient = new UserClient();
        ...
        public UserSteps(UserServiceProvider userServiceProvider, DataContext context)
        {
