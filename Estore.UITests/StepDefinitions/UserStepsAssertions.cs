    ...
    public sealed class UserStepsAssertions
    {
        ...
        public void ThenTheInformationDisplayedHasTheExpectedInformationForTheTransaction()
        {
            Assert.Multiple(() =>
            {
                ...
                Assert.That(_context.ChargeResponse.Body, Is.EqualTo(_context.TransactionInfo.TransactionId));
            });
        }
        ...
        public void ThenSecondTransactionHasTheRevertAndExpectedInformation(string state)
        {
            Assert.Multiple(() =>
            {
                ...
                Assert.That(_context.UserIdTransaction, Is.EqualTo(_context.RevertTransactionInfo.TransactionId));
        ...
        public void ThenTheFirstTransactionHasTheRevertAmount()
        {
            Assert.Multiple(() =>
            {
                ...
                Assert.That(_context.RevertUserIdTransaction, Is.EqualTo(_context.TransactionInfo.TransactionId));
